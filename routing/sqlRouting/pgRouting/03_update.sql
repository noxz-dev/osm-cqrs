-- https://github.com/makinacorpus/ImpOsm2pgRouting/blob/master/pgRouting/03_update.sql
...
CREATE TRIGGER trigger_osm_ways_changes
    AFTER INSERT OR UPDATE OR DELETE ON public.osm_ways
    FOR EACH ROW
...
BEGIN
    RAISE NOTICE 'APPLY CHANGES TO NETWORK';
